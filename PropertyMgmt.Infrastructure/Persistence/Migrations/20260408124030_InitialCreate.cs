        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PasswordHash = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanCreateTenants = table.Column<bool>(type: "bit", nullable: false),
                    CanSuspendTenants = table.Column<bool>(type: "bit", nullable: false),
                    CanViewAllAuditLogs = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedByMasterAdminId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tenants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tenants_MasterAdmins_CreatedByMasterAdminId",
                        column: x => x.CreatedByMasterAdminId,
                        principalTable: "MasterAdmins",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tenants_CreatedByMasterAdminId",
                table: "Tenants",
                column: "CreatedByMasterAdminId");
        }
